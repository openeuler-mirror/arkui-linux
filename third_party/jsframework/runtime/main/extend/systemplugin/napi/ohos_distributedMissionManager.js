...
export function mockDistributedMissionManager() {
  const distributedMissionManager = {
    startSyncRemoteMissions: function (...args) {
      console.warn('distributedMissionManager.startSyncRemoteMission interface mocked in the Previewer. How this interface works on the' +
