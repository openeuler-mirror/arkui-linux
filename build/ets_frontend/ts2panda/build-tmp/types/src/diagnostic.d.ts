...
export declare function createDiagnosticOnFirstToken(file: ts.SourceFile, node: ts.Node, message: ts.DiagnosticMessage, ...args: (string | number | undefined)[]): ts.DiagnosticWithLocation;
export declare function createFileDiagnostic(node: ts.Node, message: ts.DiagnosticMessage, ...args: (string | number | undefined)[]): any;
export declare function createDiagnostic(file: ts.SourceFile | undefined, location: ts.Node | undefined, message: ts.DiagnosticMessage, ...args: (string | number | undefined)[]): any;
