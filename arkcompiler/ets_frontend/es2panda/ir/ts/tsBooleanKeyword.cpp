...
void TSBooleanKeyword::Compile([[maybe_unused]] compiler::PandaGen *pg) const {}
...
void TSBooleanKeyword::UpdateSelf([[maybe_unused]] const NodeUpdater &cb, [[maybe_unused]] binder::Binder *binder) {}
