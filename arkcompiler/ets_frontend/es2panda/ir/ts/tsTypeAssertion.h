...
public:
    explicit TSTypeAssertion(Expression *typeAnnotation, Expression *expression)
        : Expression(AstNodeType::TS_TYPE_ASSERTION), typeAnnotation_(typeAnnotation), expression_(expression)
    {
    }
