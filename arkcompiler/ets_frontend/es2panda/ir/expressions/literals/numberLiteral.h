...
public:
    explicit NumberLiteral(double num) : Literal(AstNodeType::NUMBER_LITERAL), number_(num) {}
    explicit NumberLiteral(double num, util::StringView str)
        : Literal(AstNodeType::NUMBER_LITERAL), number_(num), str_(str)
    {
    }
    ...
    {
        return IsInteger() ? LiteralTag::INTEGER : LiteralTag::DOUBLE;
    }
