...
public:
    explicit BlockStatement(binder::Scope *scope, ArenaVector<Statement *> &&statementList)
        : Statement(AstNodeType::BLOCK_STATEMENT), scope_(scope), statements_(std::move(statementList))
    {
    }
