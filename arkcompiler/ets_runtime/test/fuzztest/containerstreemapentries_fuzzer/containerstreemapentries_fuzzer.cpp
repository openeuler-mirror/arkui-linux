...
#include "containerstreemapentries_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapEntriesFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapEntriesFuzzTest(data, size);
    return 0;
}