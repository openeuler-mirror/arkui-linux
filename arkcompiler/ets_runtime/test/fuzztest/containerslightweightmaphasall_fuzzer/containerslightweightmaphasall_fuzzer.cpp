...
#include "containerslightweightmaphasall_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapHasAllhFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::HasAll(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapHasAllhFuzzTest(data, size);
    return 0;
}