...
#include "containerstreesetconstructor_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetConstructorFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::TreeSetConstructor(callInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetConstructorFuzzTest(data, size);
    return 0;
}