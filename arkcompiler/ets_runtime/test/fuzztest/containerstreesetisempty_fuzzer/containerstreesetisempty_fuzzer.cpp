...
#include "containerstreesetisempty_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetIsEmptyFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::IsEmpty(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetIsEmptyFuzzTest(data, size);
    return 0;
}