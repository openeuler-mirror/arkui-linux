...
#include "containersstacklocate_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersStackLocateFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersStack::Locate(callInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersStackLocateFuzzTest(data, size);
    return 0;
}