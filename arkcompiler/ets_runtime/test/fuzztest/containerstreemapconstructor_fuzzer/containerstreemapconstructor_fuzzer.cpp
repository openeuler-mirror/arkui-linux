...
#include "containerstreemapconstructor_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapConstructorFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapConstructorFuzzTest(data, size);
    return 0;
}