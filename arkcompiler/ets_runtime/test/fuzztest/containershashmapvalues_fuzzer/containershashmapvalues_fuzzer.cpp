 ...
 */
#include "containershashmapvalues_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapValuesFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapValuesFuzzTest(data, size);
    return 0;
}