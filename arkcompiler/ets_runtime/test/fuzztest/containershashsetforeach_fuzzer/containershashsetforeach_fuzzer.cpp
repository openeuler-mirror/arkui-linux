...
#include "containershashsetforeach_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashSetForEachFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersHashSet::ForEach(callInfoValues);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashSetForEachFuzzTest(data, size);
    return 0;
}