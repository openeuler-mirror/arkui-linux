...
#include "containerstreesetgetlastvalue_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetGetLastValueFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::GetLastValue(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetGetLastValueFuzzTest(data, size);
    return 0;
}