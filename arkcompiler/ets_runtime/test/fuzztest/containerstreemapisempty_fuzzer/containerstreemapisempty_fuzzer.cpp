...
#include "containerstreemapisempty_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapIsEmptyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapIsEmptyFuzzTest(data, size);
    return 0;
}