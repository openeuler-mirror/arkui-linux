...
#include "containerstreesetgetfirstvalue_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetGetFirstValueFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::GetFirstValue(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetGetFirstValueFuzzTest(data, size);
    return 0;
}