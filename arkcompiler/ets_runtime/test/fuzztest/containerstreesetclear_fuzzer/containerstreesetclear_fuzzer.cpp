...
#include "containerstreesetclear_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetClearFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::Clear(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetClearFuzzTest(data, size);
    return 0;
}