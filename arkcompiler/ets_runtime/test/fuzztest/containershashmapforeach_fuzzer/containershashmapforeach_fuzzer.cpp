 ...
 */
#include "containershashmapforeach_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapForEachFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapForEachFuzzTest(data, size);
    return 0;
}