...
#include "containerslightweightmapremove_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapRemoveFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::Remove(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapRemoveFuzzTest(data, size);
    return 0;
}