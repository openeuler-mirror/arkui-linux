...
#include "containerstreesetpoplast_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetPopLastFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::PopLast(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetPopLastFuzzTest(data, size);
    return 0;
}