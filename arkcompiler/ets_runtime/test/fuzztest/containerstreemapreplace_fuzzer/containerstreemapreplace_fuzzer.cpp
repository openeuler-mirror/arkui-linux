...
#include "containerstreemapreplace_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapReplaceFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapReplaceFuzzTest(data, size);
    return 0;
}