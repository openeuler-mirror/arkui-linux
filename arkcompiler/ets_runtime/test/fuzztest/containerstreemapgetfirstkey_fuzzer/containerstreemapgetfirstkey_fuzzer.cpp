...
#include "containerstreemapgetfirstkey_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapGetFirstKeyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapGetFirstKeyFuzzTest(data, size);
    return 0;
}