...
#include "containerslightweightmapisempty_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapIsEmptyFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::IsEmpty(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapIsEmptyFuzzTest(data, size);
    return 0;
}