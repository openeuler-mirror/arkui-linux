...
#include "containersstackpeek_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersStackPeekFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersStackPeekFuzzTest(data, size);
    return 0;
}