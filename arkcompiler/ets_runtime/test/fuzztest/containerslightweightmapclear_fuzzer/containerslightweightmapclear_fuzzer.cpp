...
#include "containerslightweightmapclear_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapClearFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::Clear(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapClearFuzzTest(data, size);
    return 0;
}