...
#include "containerstreemapsetall_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapSetAllFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapSetAllFuzzTest(data, size);
    return 0;
}