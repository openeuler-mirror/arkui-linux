...
#include "containershashmapisempty_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapIsEmptyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapIsEmptyFuzzTest(data, size);
    return 0;
}