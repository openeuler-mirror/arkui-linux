...
#include "containerslightweightmapkeys_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapKeysFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapKeysFuzzTest(data, size);
    return 0;
}