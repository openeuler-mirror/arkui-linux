 ...
 */
#include "containershashmapremove_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapRemoveFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapRemoveFuzzTest(data, size);
    return 0;
}