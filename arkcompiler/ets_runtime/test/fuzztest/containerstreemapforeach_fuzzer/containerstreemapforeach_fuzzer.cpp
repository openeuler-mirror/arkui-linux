...
#include "containerstreemapforeach_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapForEachFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapForEachFuzzTest(data, size);
    return 0;
}