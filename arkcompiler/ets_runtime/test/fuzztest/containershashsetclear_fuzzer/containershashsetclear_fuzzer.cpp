...
#include "containershashsetclear_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashSetClearFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersHashSet::Clear(callInfoIsEmpty);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashSetClearFuzzTest(data, size);
    return 0;
}