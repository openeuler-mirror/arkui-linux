 ...
 */
#include "containershashmapgetlength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapGetLengthFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapGetLengthFuzzTest(data, size);
    return 0;
}