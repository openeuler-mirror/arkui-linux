...
#include "containerslightweightmap_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapFuzzTest(data, size);
    return 0;
}