...
#include "containersqueue_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersQueueFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersQueue::QueueConstructor(callInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersQueueFuzzTest(data, size);
    return 0;
}