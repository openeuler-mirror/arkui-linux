...
#include "containerstreemapgetlastkey_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapGetLastKeyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapGetLastKeyFuzzTest(data, size);
    return 0;
}