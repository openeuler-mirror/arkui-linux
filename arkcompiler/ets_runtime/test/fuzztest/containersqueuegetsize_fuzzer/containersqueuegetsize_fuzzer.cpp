...
#include "containersqueuegetsize_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersQueueGetSizeFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersQueueGetSizeFuzzTest(data, size);
    return 0;
}