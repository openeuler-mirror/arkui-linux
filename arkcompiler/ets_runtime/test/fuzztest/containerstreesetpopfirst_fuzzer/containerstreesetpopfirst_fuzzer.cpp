...
#include "containerstreesetpopfirst_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetPopFirstFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::PopFirst(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetPopFirstFuzzTest(data, size);
    return 0;
}