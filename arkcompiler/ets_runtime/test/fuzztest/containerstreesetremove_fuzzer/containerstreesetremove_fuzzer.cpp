...
#include "containerstreesetremove_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetRemoveFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::Remove(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetRemoveFuzzTest(data, size);
    return 0;
}