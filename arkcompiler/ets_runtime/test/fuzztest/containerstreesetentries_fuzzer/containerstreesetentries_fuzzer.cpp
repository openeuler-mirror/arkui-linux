...
#include "containerstreesetentries_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetEntriesFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::Entries(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetEntriesFuzzTest(data, size);
    return 0;
}