...
#include "containerstreesetgetlength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetGetLengthFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::GetLength(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetGetLengthFuzzTest(data, size);
    return 0;
}