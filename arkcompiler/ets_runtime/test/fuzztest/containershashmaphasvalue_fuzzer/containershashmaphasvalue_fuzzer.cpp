 ...
 */
#include "containershashmaphasvalue_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapHasValueFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapHasValueFuzzTest(data, size);
    return 0;
}