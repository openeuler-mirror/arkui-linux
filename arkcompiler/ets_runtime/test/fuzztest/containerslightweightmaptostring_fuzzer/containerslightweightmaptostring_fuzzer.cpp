...
#include "containerslightweightmaptostring_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapToStringFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::ToString(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapToStringFuzzTest(data, size);
    return 0;
}