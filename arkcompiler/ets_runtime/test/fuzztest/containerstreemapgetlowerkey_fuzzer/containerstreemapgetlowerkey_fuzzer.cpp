...
#include "containerstreemapgetlowerkey_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapGetLowerKeyFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapGetLowerKeyFuzzTest(data, size);
    return 0;
}