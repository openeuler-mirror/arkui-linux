...
#include "containersstackgetlength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersStackGetLengthFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersStackGetLengthFuzzTest(data, size);
    return 0;
}