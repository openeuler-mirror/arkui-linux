...
#include "containerslightweightmaplength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapLengthFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::Length(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapLengthFuzzTest(data, size);
    return 0;
}