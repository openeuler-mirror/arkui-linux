...
#include "containerstreemapclear_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapClearFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapClearFuzzTest(data, size);
    return 0;
}