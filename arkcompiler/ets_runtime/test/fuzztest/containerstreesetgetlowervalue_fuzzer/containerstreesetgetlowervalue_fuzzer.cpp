...
#include "containerstreesetgetlowervalue_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetGetLowerValueFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::GetLowerValue(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetGetLowerValueFuzzTest(data, size);
    return 0;
}