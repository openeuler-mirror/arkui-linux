...
#include "containersstack_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersStackFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersStack::StackConstructor(callInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersStackFuzzTest(data, size);
    return 0;
}