...
#include "containerstreemapgetlength_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapGetLengthFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapGetLengthFuzzTest(data, size);
    return 0;
}