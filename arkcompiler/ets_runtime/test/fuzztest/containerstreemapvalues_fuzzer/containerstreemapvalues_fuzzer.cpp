...
#include "containerstreemapvalues_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeMapValuesFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeMapValuesFuzzTest(data, size);
    return 0;
}