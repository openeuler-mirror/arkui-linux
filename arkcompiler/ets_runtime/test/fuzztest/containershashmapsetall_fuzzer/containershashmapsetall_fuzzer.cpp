 ...
 */
#include "containershashmapsetall_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapSetAllFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapSetAllFuzzTest(data, size);
    return 0;
}