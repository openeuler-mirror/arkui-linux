...
#include "containershashmapclear_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersHashMapClearFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersHashMapClearFuzzTest(data, size);
    return 0;
}