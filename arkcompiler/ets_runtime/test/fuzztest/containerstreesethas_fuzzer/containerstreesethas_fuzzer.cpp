...
#include "containerstreesethas_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersTreeSetHasFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersTreeSet::Has(objCallInfo);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersTreeSetHasFuzzTest(data, size);
    return 0;
}