...
#include "containerslightweightmapforeach_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersLightWeightMapForEachFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        ContainersLightWeightMap::ForEach(callInfo2);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersLightWeightMapForEachFuzzTest(data, size);
    return 0;
}