...
class JSAPILightWeightMapIterator : public JSObject {
public:
    static JSAPILightWeightMapIterator *Cast(TaggedObject *obj)
    {
        ASSERT(JSTaggedValue(obj).IsJSAPILightWeightMapIterator());
    ...
    DECL_VISIT_OBJECT_FOR_JS_OBJECT(JSObject, ITERATED_LIGHT_WEIGHT_MAP_OFFSET, NEXT_INDEX_OFFSET)
