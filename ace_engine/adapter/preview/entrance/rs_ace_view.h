...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_RS_ACE_VIEW_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_RS_ACE_VIEW_H
...
class RSAceView : public AceView, public Referenced {
public:
    explicit RSAceView(int32_t instanceId) : instanceId_(instanceId) {}
    ~RSAceView() override = default;
...
private:
    ...
    ACE_DISALLOW_COPY_AND_MOVE(RSAceView);
};

} // namespace OHOS::Ace::Platform

#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_RS_ACE_VIEW_H
