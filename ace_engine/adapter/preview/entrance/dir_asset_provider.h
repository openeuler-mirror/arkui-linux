...
#ifndef FOUNDATION_ACE_ADAPTER_PREVIEW_ENTRANCE_DIR_ASSET_PROVIDER_H
#define FOUNDATION_ACE_ADAPTER_PREVIEW_ENTRANCE_DIR_ASSET_PROVIDER_H
...
#endif // FOUNDATION_ACE_ADAPTER_PREVIEW_ENTRANCE_DIR_ASSET_PROVIDER_H
