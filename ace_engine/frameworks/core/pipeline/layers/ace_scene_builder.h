...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_LAYERS_ACE_SCENE_BUILDER_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_LAYERS_ACE_SCENE_BUILDER_H
...
class AceSceneBuilder : public SceneBuilder {
    DECLARE_ACE_TYPE(AceSceneBuilder, SceneBuilder)
public:
    AceSceneBuilder();
    ~AceSceneBuilder() override = default;
...
private:
    std::unique_ptr<flutter::OHOS::LayerTreeBuilder> layerTreeBuilder_;
};
