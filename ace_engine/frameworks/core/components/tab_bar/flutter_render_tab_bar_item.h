...
class FlutterRenderTabBarItem : public RenderTabBarItem {
    DECLARE_ACE_TYPE(FlutterRenderTabBarItem, RenderTabBarItem);
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TAB_BAR_FLUTTER_RENDER_TAB_BAR_ITEM_H
