...
void FlutterRenderCheckbox::SetUIStatus(
    ScopedCanvas& canvas, Offset& paintOffset, flutter::Paint& strokePaint, flutter::Paint& shadowPaint)
{
    switch (uiStatus_) {
...
void FlutterRenderCheckbox::DrawPartSelect(const ScopedCanvas& canvas, const Offset& origin,
    flutter::Paint& strokePaint, const flutter::Paint& shadowPaint) const
{
