...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_FILTER_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_FILTER_H
...
class FlutterRenderSvgFilter : public RenderSvgFilter {
    DECLARE_ACE_TYPE(FlutterRenderSvgFilter, RenderSvgFilter)
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_SVG_FLUTTER_RENDER_SVG_FILTER_H
