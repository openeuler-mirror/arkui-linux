...
class RosenRenderOption final : public RenderOption {
    DECLARE_ACE_TYPE(RosenRenderOption, RenderOption);

public:
    RosenRenderOption() = default;
    ~RosenRenderOption() override = default;
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_OPTION_ROSEN_RENDER_OPTION_H
