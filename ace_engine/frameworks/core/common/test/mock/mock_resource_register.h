...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMMON_TEST_MOCK_MOCK_RESOURCE_REGISTER_H
#define FOUNDATION_ACE_FRAMEWORKS_CORE_COMMON_TEST_MOCK_MOCK_RESOURCE_REGISTER_H
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMMON_TEST_MOCK_MOCK_RESOURCE_REGISTER_H
