...
class JsiTimerModule {
public:
    JsiTimerModule() = default;
    ~JsiTimerModule() = default;
    static JsiTimerModule* GetInstance();
    void InitTimerModule(const shared_ptr<JsRuntime>& runtime, shared_ptr<JsValue>& moduleObj);
...
#endif // FRAMEWORKS_BRIDGE_DECLARATIVE_FRONTEND_ENGINE_JSI_MODULES_JSI_TIMER_MODULE_H
